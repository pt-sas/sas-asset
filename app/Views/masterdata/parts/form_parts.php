<div class="card-body card-form">
    <form class="form-horizontal" id="form_parts">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="product_category_id">Product Category <span class="required">*</span></label>
                    <select class="form-control select-data" id="product_category_id" name="product_category_id"
                        data-url="category/getList">
                        <option value="">Select Product</option>
                    </select>
                    <small class="form-text text-danger" id="error_product_category_id"></small>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control select-data" id="md_brand_id" name="md_brand_id"
                        data-url="brand/getList">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control select-data" id="md_category_id" name="md_category_id"
                        data-url="category/getList/$MasterPart">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select class="form-control select-data" id="md_variant_id" name="md_variant_id"
                        data-url="variant/getList/$MasterPart">
