...
<form id="parameter_assetdetail">
    <div class="card-body">
        ...
        <div class="form-group row">
            <label for="md_variant_id" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Variant</label>
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-variant" name="md_variant_id"></select>
            </div>
        </div>
        <div class="form-group row">
