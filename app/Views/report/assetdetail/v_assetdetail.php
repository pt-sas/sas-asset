    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-groupasset" multiple="multiple" name="md_groupasset_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-brand" multiple="multiple" name="md_brand_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-category" multiple="multiple" name="md_category_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-subcategory" multiple="multiple" name="md_subcategory_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-type" multiple="multiple" name="md_type_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select-division" multiple="multiple" name="md_division_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <select class="form-control multiple-select" multiple="multiple" name="md_room_id">
