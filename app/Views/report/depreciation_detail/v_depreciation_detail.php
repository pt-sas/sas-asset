...
<form id="parameter_report">
    <div class="card-body">
        ...
        <div class="form-group row">
            <label for="period" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Period </label>
            <div class="col-lg-6 col-md-9 col-sm-8 select2-input select2-primary">
                <input type="text" class="form-control datepicker-year" name="period" value=<?= $month ?>
                    required></input>
            </div>
        </div>
        <div class="form-group row">
