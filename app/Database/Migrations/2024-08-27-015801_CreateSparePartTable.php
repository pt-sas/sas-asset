...
class CreateSparePartTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'md_sparepart_id'       => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
        ...
        $this->forge->addKey('md_sparepart_id', true);
        $this->forge->createTable('md_sparepart', true);
    }

    public function down()
    {
        $this->forge->dropTable('md_sparepart', true);
    }
}
