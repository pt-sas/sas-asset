...
class CreateSubcategoryTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'md_subcategory_id'     => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
        ...
        $this->forge->addKey('md_subcategory_id', true);
        $this->forge->createTable('md_subcategory', true);
    }

    public function down()
    {
        $this->forge->dropTable('md_subcategory', true);
    }
}
