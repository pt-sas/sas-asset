...
class CreateTrxServiceTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'trx_service_id'        => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
            ...
            'servicedate'           => ['type' => 'timestamp', 'null' => false],
        ...
        $this->forge->addKey('trx_service_id', true);
        $this->forge->createTable('trx_service', true);
    }

    public function down()
    {
        $this->forge->dropTable('trx_service', true);
    }
}
