...
class CreateMenuTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'sys_menu_id'           => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
        ...
        $this->forge->addKey('sys_menu_id', true);
        $this->forge->createTable('sys_menu', true);
    }

    public function down()
    {
        $this->forge->dropTable('sys_menu', true);
    }
}
