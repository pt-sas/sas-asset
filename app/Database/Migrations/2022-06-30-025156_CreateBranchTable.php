...
class CreateBranchTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'md_branch_id'          => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
            ...
            'leader_id'             => ['type' => 'INT', 'constraint' => 6, 'null' => false],
            'phone'                 => ['type' => 'VARCHAR', 'constraint' => 40, 'null' => false]
        ]);
        $this->forge->addKey('md_branch_id', true);
        $this->forge->createTable('md_branch', true);
    }

    public function down()
    {
        $this->forge->dropTable('md_branch', true);
    }
}
