...
class CreateBrandTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'md_brand_id'           => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
        ...
        $this->forge->addKey('md_brand_id', true);
        $this->forge->createTable('md_brand', true);
    }

    public function down()
    {
        $this->forge->dropTable('md_brand', true);
    }
}
