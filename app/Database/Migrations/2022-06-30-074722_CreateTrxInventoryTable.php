...
class CreateTrxInventoryTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'trx_inventory_id'      => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
            ...
            'inventorydate'         => ['type' => 'timestamp', 'null' => false],
            ...
            'trx_receipt_id'        => ['type' => 'INT', 'constraint' => 6, 'null' => true],
            'trx_receipt_detail_id' => ['type' => 'INT', 'constraint' => 6, 'null' => true],
        ]);
        $this->forge->addKey('trx_inventory_id', true);
        $this->forge->createTable('trx_inventory', true);
    }

    public function down()
    {
        $this->forge->dropTable('trx_inventory', true);
    }
}
