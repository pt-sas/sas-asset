...
class CreateVariantTable extends Migration
{
    ...
    {
        $this->forge->addField([
            'md_variant_id'           => ['type' => 'INT', 'constraint' => 6, 'null' => false, 'auto_increment' => true],
        ...
        $this->forge->addKey('md_variant_id', true);
        $this->forge->createTable('md_variant', true);
    }

    public function down()
    {
        $this->forge->dropTable('md_variant', true);
    }
}
