...
class Variant extends BaseController
{
    public function __construct()
    {
        ...
        $this->model = new M_Variant($this->request);
        $this->entity = new \App\Entities\Variant();
    }
    ...
    public function index()
    {
        ...
        return $this->template->render('masterdata/variant/v_variant', $data);
    }
    ...
    public function create()
    {
        if ($this->request->getMethod(true) === 'POST') {
            ...
            try {
                ...
                if (!$this->validation->run($post, 'variant')) {
        ...
        if ($this->request->isAjax()) {
            ...
            try {
                ...
                foreach ($list as $key => $row) :
                    $response[$key]['id'] = $row->getVariantId();
